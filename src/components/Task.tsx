...
const Task = ({ task, completed, onMark, onDelete }: TaskProps) => {
  return (
    <div className="flex items-center pt-[0.89rem] pb-[0.93rem] bg-light-gray px-[1.2rem] dark:bg-gray-blue-600 md:pt-[1rem] md:pb-[1.04rem] md:px-[1.5rem]">
      <button
        onClick={onMark}
      ...
      >
        {completed ? <img src={checkIcon} className="w-full h-full" /> : <></>}
      </button>
      <p
